...
class DRConfig(TrainConfig):
    ...
    lr: float = 2e-4 #Best for DR
    weight_decay: float = 1e-6 #Best for DR
    # Paper lr_patience=5
    lr_patience: int = 8 #Best for DR
    early_stop_patience: int = 20 #Best for DR
    ...
    temperature: float = 0.7 #Best for DR
