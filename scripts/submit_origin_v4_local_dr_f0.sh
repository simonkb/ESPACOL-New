#!/bin/bash
# RF-sealed ORIGIN controlled experiment: EyePACS fold 0. This wrapper changes
...
#SBATCH --job-name=origin_v4_ldr0
...
#SBATCH --output=/dpc/kuin0170/ESPACOL-New/origin_v4_local_dr_f0_%j.out
#SBATCH --error=/dpc/kuin0170/ESPACOL-New/origin_v4_local_dr_f0_%j.err
...
cd "${REPO_ROOT}"
export ORIGIN_RUN_DIR="${ORIGIN_LOCAL_DR_RUN_DIR:-runs/origin_dr_f0_v4_local_s4s8}"
...
echo "=== ORIGIN-v4 RF-sealed local-evidence EyePACS fold 0 ==="
