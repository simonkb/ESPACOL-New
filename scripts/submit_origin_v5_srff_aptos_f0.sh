#!/bin/bash
# ORIGIN-v5 SRFF APTOS fold-0 development run. Relative to the bounded v3
...
#SBATCH --output=/dpc/kuin0170/ESPACOL-New/origin_v5_srff_aptos_f0_%j.out
#SBATCH --error=/dpc/kuin0170/ESPACOL-New/origin_v5_srff_aptos_f0_%j.err
...
export ORIGIN_RUN_DIR="${ORIGIN_SRFF_APTOS_RUN_DIR:-runs/origin_aptos_f0_v5_srff_w16}"
...
echo "=== ORIGIN-v5 SRFF APTOS fold 0 / inner validation only ==="
