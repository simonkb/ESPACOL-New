#!/bin/bash
# ORIGIN-v6 explicit regional-relation pilot: hash-bound v3 EyePACS fold 0
# warm start, epoch-0 no-regression floor, and relation-only optimization.
#SBATCH --job-name=origin_v6_rdr0
...
#SBATCH --output=/dpc/kuin0170/ESPACOL-New/origin_v6_relation_dr_f0_%j.out
#SBATCH --error=/dpc/kuin0170/ESPACOL-New/origin_v6_relation_dr_f0_%j.err
...
RUN_DIR="${ORIGIN_RUN_DIR:-runs/origin_dr_f0_v6_relation_only}"
...
echo "=== ORIGIN-v6 relation-only EyePACS fold 0 / inner validation only ==="
