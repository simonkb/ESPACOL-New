#!/bin/bash
# ORIGIN-v7 identified sparse relation pilot: hash-bound v3 APTOS fold 0.
# Only the zero-initialized relation field is optimized; the v3 base remains
# frozen and in evaluation mode throughout this controlled screen.
#SBATCH --job-name=origin_v7_a0
...
#SBATCH --output=/dpc/kuin0170/ESPACOL-New/origin_v7_aptos_f0_%j.out
#SBATCH --error=/dpc/kuin0170/ESPACOL-New/origin_v7_aptos_f0_%j.err
...
RUN_DIR="${ORIGIN_RUN_DIR:-runs/origin_aptos_f0_v7_identified_sparse_k8}"
...
echo "=== ORIGIN-v7 identified-sparse APTOS fold 0 / inner validation only ==="
